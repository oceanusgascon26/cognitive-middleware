...
The code, tests and benches here were developed with AI coding assistance under the author's direction. The tests are hermetic and the benches are deterministic in their scoring, so what the kit measures does not depend on who or what wrote it.
